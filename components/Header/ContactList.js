...
const ContactList = () => {
  ...
  return (
    <div className="w-200 md:block hidden">
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative">
          <Listbox.Button className="flex w-200 cursor-pointer p-xs2 text-left focus:outline-none  text-textPrimary focus-visible:ring-offset-orange-300 text-base">
