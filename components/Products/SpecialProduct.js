...
const SpecialProduct = () => {
  return (
    <>
      <div className="special-order-image tablet600:border-x border-borderDefault"></div>
      <div className="wave-shape tablet600:border-x border-b border-borderDefault rounded-b-lg"></div>
