...
const PopularProducts = () => {
  ...
  return (
    <section className="mb-6 popular-products">
      {isLoading && data.length === 0 && <Loader />}

      <div className="flex gap-4 tablet600:gap-3">
        <div className="product-card relative">
          ...
          <ul className="flex gap-[7px] overflow-x-auto tablet600:gap-xs tablet600:max-w-[50%] tablet1024:gap-s desktop1200:gap-sPlus">
